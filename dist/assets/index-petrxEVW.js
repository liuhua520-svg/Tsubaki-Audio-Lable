...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    _cache[1] || (_cache[1] = createBaseVNode("header", { class: "app-header" }, [
      createBaseVNode("h1", null, "Tsubaki Audio Lable"),
      createBaseVNode("p", null, "音频标注与音高处理工作室")
    ], -1)),
    createBaseVNode("main", _hoisted_2, [
      createBaseVNode("div", _hoisted_3, [
        _cache[0] || (_cache[0] = createBaseVNode("h2", null, "欢迎使用 Tsubaki Audio Lable", -1)),
        createBaseVNode("p", null, "后端: " + toDisplayString(_ctx.backend), 1),
        createBaseVNode("p", null, "API URL: " + toDisplayString(_ctx.baseURL), 1)
      ])
    ])
  ]);
}
